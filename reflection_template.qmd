...
```{r}
#| label: wd-4-numeric-ex-1, Challenge 4 e Question 3
```{r}
...
```{r}
#| label: wd-5-right Lab 4 Question 2 Revised
...
```{r}
#| label: wd-5-left-right-ex-2 Lab 4 Question 3
...
```{r}
#| label: dsm-2-1 Challenge 3 Question 3
chisq.test(
...
```{r}
#| label: dsm-2-2 Lab 2 Question 17
#| label: anova
...
```{r}
#| label: dsm-2-3 Lab 1 Question 5
t.test(len ~ supp, 
       data = ToothGrowth,
       var.equal = FALSE,  
